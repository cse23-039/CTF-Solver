...
class DifficultyEstimator:
    ...
    UP_CLASSIFY_THRESHOLD = 0.4
    DOWN_CLASSIFY_THRESHOLD = 2.0
    ...
    def reestimate(self, iteration: int, fruitless: int, tool_failures: int, evidence_log: list[dict], route_score: int = 50) -> dict[str, Any]:
        self._fired = True

        successful_evidence = [e for e in (evidence_log or []) if e.get("success") or e.get("progress")]
